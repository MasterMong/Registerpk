...
-- Dumping structure for table student_register.types
...
-- Dumping data for table student_register.types: ~3 rows (approximately)
DELETE FROM `types`;
INSERT INTO `types` (`code`, `name`, `min_GPAX`, `min_GPA_MAT`, `min_GPA_SCI`, `allow_ungrade`, `allow_not_meet_req`, `allow_behavior_fail`, `img_cover`) VALUES
