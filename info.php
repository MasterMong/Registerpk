...
<body style="font-family: Prompt, sans-serif;">
    ...
    <main>
        <div class="container">
            <div style="padding-top: 10px;" class="card-background" data-aos="zoom-in" data-aos-delay="150" data-aos-duration="1000">
                ...
                <?php if (isset($_SESSION['username'])): ?>
                    ...
                    <span> เกรดเฉลี่ย : </span><span class="badge bg-secondary" style="color: #ff3900!important;">5 เทอม <?php echo $_SESSION['grade']; ?></span> 
